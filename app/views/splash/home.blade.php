    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="form-group">
                <label for="inputLogoFile" class="col-sm-1 control-label">Logo: </label>
                <div class="col-sm-11">
                    <input type="file" class="form-control" id="inputLogoFile">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-1 control-label">背景:</label>
                <div class="col-sm-11">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="file" class="form-control" id="inputBgFile">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-3">
            <div id="jumbotron_img_box" style="margin-top:0; width: auto; height: auto;">
